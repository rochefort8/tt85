...
INSERT INTO `customer_customer` VALUES (1,0,0,'è»åŽŸ','ã‚ªã‚®ãƒãƒ©','','','','','','','','','85','','','','',0,'','','','å°šè²´','ãƒŠã‚ªã‚­','','','','','','ogihara',NULL,'2016-10-17 10:32:26',NULL);
...
-- Dump completed on 2016-10-17 10:32:49
