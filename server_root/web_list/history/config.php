...
?>
<h1>履歴設定<?=$view->caption($hash['folder'], array(0=>'トップ / 標準設定'))?></h1>
<ul class="operate">
	<li><a href="index.php<?=$view->parameter(array('folder'=>$_GET['folder']))?>">履歴一覧に戻る</a></li>
<?php
if ($_GET['folder'] > 0) {
...
?>
	...
	<span class="operator" onclick="Customer.increment(20)">追加</span>
